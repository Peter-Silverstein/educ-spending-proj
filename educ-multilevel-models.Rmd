...
Figure_2 <- ggplot(mean_educ_spending_by_year, aes(x = Year, y = mean_educ_spending)) +
  geom_line(color = "blue") +
  geom_point(color = "blue") +
  labs(
    title = "Figure 2: Mean Education Spending by Year (2016 USD)",
    x = "Year",
    y = "Mean Education Spending",
  )
...
```{r}
Figure_3 <- ggplot(mean_educ_spending_by_state, aes(x = State, y = mean_educ_spending)) +
  geom_col(fill = "blue") +
  labs(
    title = "Figure 3: Mean Education Spending Per Pupil by State (2016 USD) ",
    x = "State",
    y = "Mean Education Spending Per Pupul"
  ) +
...
Figure_4 <- ggplot(mean_educ_spending_by_state, aes(x = mean_r_unified_control, y = mean_educ_spending, label = State)) +
  geom_text(color = "black", size = 3) +
  labs(
    title = "Figure 4: Mean Education Spending Per Pupil vs Republican Unified Control by State",
...
modelsummary(
  list("Model 1" = fit1, "Model 2" = fit2, "Model 3" = fit3),
  output = "markdown"   
)
